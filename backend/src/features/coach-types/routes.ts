...
export const createCoachTypeRoutes = (): FastifyPluginAsync => {
  return async (server) => {
     ...
     * Search coach types
     */
    server.get('/coach-types/search/:query', {
      schema: {
     ...
     */
    server.put('/admin/coach-types/:id', {
      schema: {
     ...
     */
    server.delete('/admin/coach-types/:id', {
      schema: {
     ...
     */
    server.post('/admin/coach-types/initialize', {
      schema: {
