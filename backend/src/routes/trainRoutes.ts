      ...
      data: {
        ...
        routeStations: {
          create: stations.map((station, index) => ({
            ...
            distanceFromStart: stations.slice(0, index + 1).reduce((sum, s) => sum + (s.distance || 0), 0),
          })),
        },
      },
      include: {
