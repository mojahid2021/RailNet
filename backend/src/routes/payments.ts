...
async function paymentRoutes(fastify: FastifyInstance) {
  ...
  fastify.get('/payments/cleanup/stats', {
    preHandler: (fastify as any).authenticate,
    schema: {
